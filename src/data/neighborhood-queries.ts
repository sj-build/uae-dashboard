...
export const NEIGHBORHOOD_QUERIES: Record<string, readonly string[]> = {
  ...
  'dubai-marina': [
    'Dubai Marina skyline night',
    'Dubai Marina yacht JBR beach',
    'Dubai Marina aerial view',
  ],
  'jlt': [
    'Jumeirah Lake Towers Dubai skyline',
    'DMCC JLT Dubai lake',
  ],
  'internet-city-media-city': [
    'Dubai Media City skyline',
    'Dubai Internet City modern office',
    'Dubai Knowledge Park buildings',
  ],
  'deira-old-dubai': [
    'Dubai Creek abra boat traditional',
    'Deira Gold Souk Dubai',
    'Old Dubai spice souk market',
  ],
  'dubai-south': [
